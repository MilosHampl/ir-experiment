...
class Evaluator:
    def __init__(self, qrels: pd.DataFrame):
        ...
        Args:
            qrels: DataFrame containing 'query_id', 'doc_id', 'relevance'.
        """
        self.qrels = qrels
        self.metrics = [
            nDCG@10,
    ...
    def evaluate(self, run_results: Dict[str, Dict[str, float]]) -> Dict[str, float]:
        ...
        Args:
            run_results: Dictionary mapping query_id to {doc_id: score}.
        ...
        # Ensure qrels query_ids and doc_ids are strings for consistency
